...
const nav = [
  ...
  {
    href: "/pages/lecturer/availability",
    label: "Availability",
    icon: (
      <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      >
        <div className="h-16 flex items-center px-6 border-b border-slate-100 shrink-0">
          ...
          <span className="font-bold text-slate-900 tracking-tight">Course Manager</span>
        </div>

        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest px-3 mb-3">Lecturer Portal</p>
